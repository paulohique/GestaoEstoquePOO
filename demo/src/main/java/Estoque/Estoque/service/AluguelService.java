...
public class AluguelService {
    ...
    @Transactional
    public Aluguel registrarAluguel(Cliente cliente, Funcionario funcionario, List<ItemAluguel> itens, FormaPagamento formaPagamento, LocalDate dataInicio, LocalDate dataTermino) {
